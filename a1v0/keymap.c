...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, KC_VOLD, KC_MUTE, KC_VOLU,                         _______, _______, _______,_______, _______, KC_F12,
  _______, _______, _______, KC_BRID, _______, KC_BRIU,                         _______, _______, _______,_______, KC_GRAVE, _______,

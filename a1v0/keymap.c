 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,    KC_RBRC,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT /*do I really want shift here? */,
                        KC_LALT, MO(_LOWER), KC_BSPC, KC_SPC,    KC_ENT, KC_DEL, MO(_RAISE), KC_RGUI /*KC_RGUI doesn't do anything*/
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
//   _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
                             KC_LWIN, _______, _______, _______,        _______,  _______, _______, KC_LWIN
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |

 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,     KC_C,     KC_V,     KC_B, KC_LBRC,         KC_RBRC, KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH, KC_RSFT,
                    _______,  KC_LALT,  KC_BSPC,  LT(_LOWER, KC_SPC),  LT(_RAISE, KC_ENT),  KC_DEL,   _______,  _______
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, KC_BRID, _______, KC_BRIU,                         KC_7,  KC_8,  KC_9,  _______, _______,  KC_F12,
  _______, _______, _______, KC_VOLD, KC_MUTE, KC_VOLU,                         KC_4,  KC_5,  KC_6,  _______, KC_GRAVE, _______,
  _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_NONUS_HASH, KC_1,  KC_2,  KC_3,  KC_DOT,  KC_NUBS,  _______,
